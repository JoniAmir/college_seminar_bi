...
ActiveRecord::Schema.define(:version => 20130214145548) do
  ...
  create_table "all_info", :id => false, :force => true do |t|
    ...
    t.integer "student_gender_code",        :limit => 8
    ...
    t.string  "g_curriculum",               :limit => 45
    t.integer "g_curriculum_code"
    t.integer "ranking"
    t.integer "ranking_total"
    t.string  "graduate_gender"
    t.integer "graduate_gender_code"
    t.integer "ID"
    t.integer "graduatep_id_number"
  ...
  add_index "all_info", ["student_id_number"], :name => "student_id_idx"

  create_table "all_info_1", :id => false, :force => true do |t|
    t.integer "year"
    t.integer "semester"
    t.integer "student_id_number"
    t.date    "birthdate"
  ...
  create_table "all_info_2", :id => false, :force => true do |t|
    t.integer "year"
    t.integer "semester"
    t.integer "student_id_number"
    t.date    "birthdate"
  ...
  add_index "all_info_2", ["student_id_number"], :name => "student_id_idx"

  create_table "all_info_c", :id => false, :force => true do |t|
    t.string  "max_y",             :limit => 23
    t.integer "year"
    t.integer "semester"
    t.integer "student_id_number"
    t.date    "birthdate"
  ...
  add_index "graduates_professions", ["id_number"], :name => "gpidnumber_idx"

  create_table "lookup", :primary_key => "ID", :force => true do |t|
